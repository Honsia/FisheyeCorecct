...
int main()
{
	string imgPath = "/media/tct/tct/fish_eye_image_correction/fisheye_data/";
	Mat srcImg = imread(imgPath + "frame.jpg");

	int inHeight = srcImg.rows;
	int inWidth = srcImg.cols;

	int outHeight = srcImg.cols;
	int outWidth = srcImg.rows;
